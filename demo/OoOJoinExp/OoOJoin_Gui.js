...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 9497552,
    DYNAMIC_BASE = 14740432,
    DYNAMICTOP_PTR = 9496608;
...
var wasmBinaryFile = 'OoOJoin_Gui.wasm';
...
var ASM_CONSTS = {
  9212864: function() {throw 'Canceled!'}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=9497536;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 9496784;
        ...
        var pthreadMainJs = locateFile('OoOJoin_Gui.worker.js');
  ...
  var ___tm_current=9496624;
  
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 9496672, 4), 9496672);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(56, 1, fildes, name);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(57, 1, name);
...
var proxiedFunctionTable = [null,_atexit,___syscall10,___syscall122,___syscall15,___syscall168,___syscall183,___syscall192,___syscall193,___syscall194,___syscall195,___syscall196,___syscall197,___syscall202,___syscall20,___syscall220,___syscall221,___syscall3,___syscall320,___syscall33,___syscall38,___syscall39,___syscall4,___syscall40,___syscall5,___syscall54,___syscall83,___syscall85,___syscall9,___syscall91,___syscall94,_tzset,_eglGetProcAddress,_emscripten_force_exit,_emscripten_get_element_css_size,_emscripten_is_webgl_context_lost,_emscripten_set_canvas_element_size_main_thread,_emscripten_set_focus_callback_on_thread,_emscripten_set_keydown_callback_on_thread,_emscripten_set_keyup_callback_on_thread,_emscripten_set_mousedown_callback_on_thread,_emscripten_set_mousemove_callback_on_thread,_emscripten_set_mouseup_callback_on_thread,_emscripten_set_resize_callback_on_thread,_emscripten_set_touchcancel_callback_on_thread,_emscripten_set_touchend_callback_on_thread,_emscripten_set_touchmove_callback_on_thread,_emscripten_set_touchstart_callback_on_thread,_emscripten_set_wheel_callback_on_thread,_emscripten_webgl_destroy_context_main_thread,_fd_close,_fd_fdstat_get,_fd_read,_fd_seek,_fd_sync,_fd_write,_fpathconf,_sysconf];
